...
request.onload = function() {
    var repairShop = request.response;
    populateHeader(repairShop);
    showHeroes(repairShop);
}

function populateHeader(jsonObj) {
  var myH1 = document.createElement('h1');
  myH1.textContent = jsonObj['repairShop'];
    
  h.appendChild(myH1);

  var myPara = document.createElement('p');
  myPara.textContent = 'Wheels ' + jsonObj['$10'] + jsonObj['$20'];
